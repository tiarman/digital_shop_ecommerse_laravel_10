        ...
        <div class="content-page">
            ...
            <footer class="footer">
                ...
                <span class="text-muted hidden-xs-down pull-right">Developed & Maintained by <a href=""
                        target="_blank">Digital Shop</a></span>
            </footer>
        </div>
    </div>
