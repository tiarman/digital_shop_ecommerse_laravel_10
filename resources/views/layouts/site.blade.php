...
<body>
    ...
    <div class="header section">
        ...
        <!-- Header Top Start -->
        <div class="header-top bg-primary set-new-color">
            <div class="container">
                ...
                <div class="row align-items-center mb-n4">
                    <div class="order-2 mb-4 text-center col-md-6 text-md-start order-md-1">
                        <div class="copyright-content">
                            <p class="mb-0">© 2023 <strong>Digital Shop </strong> Made with <i class="fa fa-heart text-danger"></i> by <a href="">Digital Shop</a></p>
                        </div>
                    </div>
